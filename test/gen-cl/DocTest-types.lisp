...
"
  (("string_thing" nil :type string :id 1 :documentation "And the members of a struct
")
   ("byte_thing" nil :type byte :id 4 :documentation "doct text goes before a comma
")
...
(thrift:def-struct "insanity"
  "Struct insanity
"
  (("userMap" nil :type (map (enum "Numberz") i64) :id 1 :documentation "This is doc for field 1
")
   ("xtructs" nil :type (list (struct "xtruct")) :id 2 :documentation "And this is doc for field 2
")))
...
(thrift:def-service "ThriftTest" nil(:documentation "This is where you would document a Service
")
